...
<st c="7859">这很复杂吗？</st> <st c="7881">有一点。</st> <st c="7895">但这就是拥有宏的好处之一——简化复杂的实现。</st> <st c="7983">重要的是要理解，每个带有</st> `<st c="8048">@Model</st>` <st c="8054">宏的类立即获得自己的存储，并添加到</st> <st c="8121">SwiftData 模式。</st>
