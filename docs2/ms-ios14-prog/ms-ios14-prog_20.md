...
![图 20.6 – 应用仪表板屏幕![图片](img/Figure_20.06_B14717.jpg)
...
1.  在 Xcode 顶部菜单中选择**产品 | 归档**，使用已选择的构建设备。当你这样做时，会开始一个比平时慢得多的构建过程。这是因为 Xcode 正在以发布模式构建你的应用，使其优化并能在任何设备上运行。
...
![图 20.9 – 上传的构建](img/Figure_20.09_B14717.jpg)
