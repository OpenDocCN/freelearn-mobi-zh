...
![图 14.1：iOS 模拟器显示应用导览中的探索屏幕](img/Figure_14.01_B17469.jpg)
...
1.  *Ctrl + 拖动* 从 `exploreNameLabel` 属性。这将为它创建一个输出端口：![图 14.14：显示 ExploreCell.swift 的编辑区域    ![图片 14.14_B17469.jpg](img/Figure_14.14_B17469.jpg)
