...
1.  按照屏幕上的说明完成购买。一旦你购买了你的账户，前往[`developer.apple.com/account/`](https://developer.apple.com/account/)并使用你购买开发者账户时使用的相同 Apple 账户登录。你应该会看到以下内容：
...
1.  你的证书将自动生成。点击**下载**将生成的证书下载到你的 Mac 上：
