...
首先，我们将添加一些截图。您可以通过同时按设备上的电源和主页按钮从您的设备创建截图。拍摄五张截图，将设备连接到Mac，并将图像传输到桌面。然后，您可以将文件从桌面拖动到iTunes应用页面上的空间。您可以单独拖放每个文件或同时拖放所有文件。点击顶部的**iPad**标签，因为我们目前只为iPad开发游戏。
