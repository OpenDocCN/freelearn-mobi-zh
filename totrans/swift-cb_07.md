...
或者，您也可以创建一个新的基于macOS的游乐场，并输入以下代码：
...
Playgrounds将列在项目导航器的顶部，与展开三角形一起。
...
本菜谱的结果可以在本书GitHub仓库的`EmbeddedSources.playground`中找到。
